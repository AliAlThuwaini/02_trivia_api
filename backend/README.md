...
### Getting Started
- This version of the app runs locally. Backend app runs at `http://127.0.0.1:5000/`.
- Authentication: Not required at this version
...
#### GET /questions
- General:
    - upon request, the following will be returned:
        - Success flag
        - List of available categories
        - List of available questions
        - Number of questions
    - Returned questions are paginated in groups of 10 questions per page.
