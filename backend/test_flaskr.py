...
class TriviaTestCase(unittest.TestCase):
    ...
    #     new_question = {
    #         'question': 'How long would it take for the sun light to travel to earth?',
    #         'answer': '8.5 minutes',
    #         'category': 1,
    #         'difficulty': 2
    #     }
    ...
    # Review this! search point returns code 200 even for non available search term!!
    # def test_422_if_question_doesnt_exist_in_search(self):
    #     search_word = {'searchTerm': 'aaaaaaaaaaaaaaaaa',}
    #     res = self.client().post('/questions/search', json=search_word)
    #     data = json.loads(res.data)
    ...
    # The below two functions should work, but still not sure why is not! Need more review. Below is the error:
